...
export function Projects() {
  return (
    <Center py={12} display='flex' flexDir='column' bg={useColorModeValue('gray.100', 'gray.900')}       
    css={{
      backgroundImage: useColorModeValue(CONFETTI_LIGHT, CONFETTI_DARK),
      backgroundAttachment: 'fixed',
    }}>
      <Heading mb={'50px'} id={'Projects'}>Projects</Heading>
      <Box
        role={'group'}
        p={6}
        maxW={'330px'}
        ...
        <Stack pt={10} align={'center'}>
          ...
          <Stack direction={'row'} align={'center'}>
            <a href='https://astonishing-raindrop-48826d.netlify.app/' target='_blank'>Click Here</a>
