...
export function Skills() {
  return (
    <Center py={12} bg={useColorModeValue('gray.50', 'gray.800')} display='flex' flexDir='column' 
    css={{
      backgroundImage: useColorModeValue(CONFETTI_LIGHT, CONFETTI_DARK),
      backgroundAttachment: 'fixed',
    }}
    >
      <Heading mb='20px' id={'Skills'}>
        Skills
      </Heading>
      <Card p='80px'>
    ...
    <Heading mb='30px' mt='50px'>Scrimba Course</Heading>
      <Text textAlign='center' w='50%' mb='30px'>Below is a certificate of completion of the Scrimba Frontend Developer Career Path course
        which is an interactive online course that helped me enhance and develop my skills with 
        over 70 hours of training. This course consisted of HTML, CSS, React, APIs, Responsive design and 
        everything that a front end developer will need to know.
      </Text>
      <Image src={Logo} alt="scrimba certificate" w={'60vw'}/>
    </Center>
